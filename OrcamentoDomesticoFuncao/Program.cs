...
namespace OrcamentoDomestico
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Total de despesas de {mae.Nome}:");
            mae.CalcularDespesas();

            Console.WriteLine($"Total de despesas de {avo.Nome}:");
            avo.CalcularDespesas();
            
            Console.WriteLine($"Total de despesas de {filho.Nome}:");
            filho.CalcularDespesas();
